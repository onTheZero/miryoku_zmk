...
L_MT(LGUI, Q),     L_MT(LALT, S),     L_MT(LCTRL, D),    L_MT(LSHFT, F),    &kp G,             &kp H,             R_MT(LSHFT, J),    R_MT(LCTRL, K),    R_MT(LALT, L),     R_MT(LGUI, M),     \
U_LT(U_BUTTON, W), L_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp COMMA,         &kp DOT,           R_MT(RALT, SLASH), U_LT(U_BUTTON, SQT),\
...
L_MT(LGUI, Y),     L_MT(LALT, I),     L_MT(LCTRL, E),    L_MT(LSHFT, A),    &kp DOT,           &kp D,             R_MT(LSHFT, S),    R_MT(LCTRL, T),    R_MT(LALT, N),     R_MT(LGUI, B),     \
U_LT(U_BUTTON, J), L_MT(RALT, SLASH), &kp COMMA,         &kp K,             &kp SQT,           &kp W,             &kp M,             &kp L,             R_MT(RALT, P),     U_LT(U_BUTTON, V), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK_FLIP \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp G,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
L_MT(LGUI, A),     L_MT(LALT, R),     L_MT(LCTRL, S),    L_MT(LSHFT, T),    &kp D,             &kp H,             R_MT(LSHFT, N),    R_MT(LCTRL, E),    R_MT(LALT, I),     R_MT(LGUI, O),     \
U_LT(U_BUTTON, Z), L_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp K,             &kp M,             &kp COMMA,         R_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_FLIP \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
L_MT(LGUI, A),     L_MT(LALT, R),     L_MT(LCTRL, S),    L_MT(LSHFT, T),    &kp G,             &kp M,             R_MT(LSHFT, N),    R_MT(LCTRL, E),    R_MT(LALT, I),     R_MT(LGUI, O),     \
U_LT(U_BUTTON, Z), L_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         R_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK_FLIP \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
L_MT(LGUI, A),     L_MT(LALT, R),     L_MT(LCTRL, S),    L_MT(LSHFT, T),    &kp G,             &kp K,             R_MT(LSHFT, N),    R_MT(LCTRL, E),    R_MT(LALT, I),     R_MT(LGUI, O),     \
U_LT(U_BUTTON, Z), L_MT(RALT, X),     &kp C,             &kp D,             &kp V,             &kp M,             &kp H,             &kp COMMA,         R_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK_FLIP \
&kp SQT,           &kp COMMA,         &kp DOT,           &kp P,             &kp Y,             &kp F,             &kp G,             &kp C,             &kp R,             &kp L,             \
L_MT(LGUI, A),     L_MT(LALT, O),     L_MT(LCTRL, E),    L_MT(LSHFT, U),    &kp I,             &kp D,             R_MT(LSHFT, H),    R_MT(LCTRL, T),    R_MT(LALT, N),     R_MT(LGUI, S),     \
U_LT(U_BUTTON, SLASH),L_MT(RALT, Q),     &kp J,             &kp K,             &kp X,             &kp B,             &kp M,             &kp W,             R_MT(RALT, V),     U_LT(U_BUTTON, Z), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK_FLIP \
&kp W,             &kp L,             &kp R,             &kp B,             &kp Z,             &kp SQT,           &kp Q,             &kp U,             &kp D,             &kp J,             \
L_MT(LGUI, S),     L_MT(LALT, H),     L_MT(LCTRL, N),    L_MT(LSHFT, T),    &kp COMMA,         &kp DOT,           R_MT(LSHFT, A),    R_MT(LCTRL, E),    R_MT(LALT, O),     R_MT(LGUI, I),     \
U_LT(U_BUTTON, F), L_MT(RALT, M),     &kp V,             &kp C,             &kp SLASH,         &kp G,             &kp P,             &kp X,             R_MT(RALT, K),     U_LT(U_BUTTON, Y), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN_FLIP \
&kp Q,             &kp D,             &kp R,             &kp W,             &kp B,             &kp J,             &kp F,             &kp U,             &kp P,             &kp SQT,           \
L_MT(LGUI, A),     L_MT(LALT, S),     L_MT(LCTRL, H),    L_MT(LSHFT, T),    &kp G,             &kp Y,             R_MT(LSHFT, N),    R_MT(LCTRL, E),    R_MT(LALT, O),     R_MT(LGUI, I),     \
U_LT(U_BUTTON, Z), L_MT(RALT, X),     &kp M,             &kp C,             &kp V,             &kp K,             &kp L,             &kp COMMA,         R_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY_FLIP \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
L_MT(LGUI, A),     L_MT(LALT, S),     L_MT(LCTRL, D),    L_MT(LSHFT, F),    &kp G,             &kp H,             R_MT(LSHFT, J),    R_MT(LCTRL, K),    R_MT(LALT, L),     R_MT(LGUI, SQT),   \
U_LT(U_BUTTON, Z), L_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         R_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ_FLIP \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Z,             &kp U,             &kp I,             &kp O,             &kp P,             \
L_MT(LGUI, A),     L_MT(LALT, S),     L_MT(LCTRL, D),    L_MT(LSHFT, F),    &kp G,             &kp H,             R_MT(LSHFT, J),    R_MT(LCTRL, K),    R_MT(LALT, L),     R_MT(LGUI, SQT),   \
U_LT(U_BUTTON, Y), L_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         R_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP
